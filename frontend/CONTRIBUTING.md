# Contributing to natural-script-demo-frontend

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

## Found an Issue?

Thank you for reporting any issues you find. We do our best to test and make `natural-script-demo-frontend` as solid as possible, but any reported issue is a real help.
...
- Provide the exact version of natural-script-demo-frontend.
- Be awesome and consider contributing a [pull request](#want-to-contribute)

## Want to contribute?

You consider contributing changes to natural-script-demo-frontend – we dig that!
...
- Consider your development for windows, linux and macOS platforms at the same time
  because having a module compatible with all platforms is the main concern of `natural-script-demo-frontend`.
...
`natural-script-demo-frontend` use [standard-version](https://github.com/conventional-changelog/standard-version) to handle versioning
